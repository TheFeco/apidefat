...
if($_POST['METHOD']=='POST'){
    ...
    END AS turno,
    c.nombre AS ciclo, m.nombre AS municipio, f.nombre AS funcion, dp.nombre AS deporte, r.nombre AS rama, cat.nombre AS categoria, peso.nombre AS peso, pruebas.nombre AS prueba, pruebas2.nombre AS prueba2,
